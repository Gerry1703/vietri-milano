...
export default function CollezioneSciarpe() {
  ...
  return (
    <section className="bg-white w-full min-h-svh md:min-h-screen snap-start snap-always flex flex-col justify-start pt-[12svh] md:pt-[16vh] pb-10 md:pb-14">
      {/* Intestazione */}
      ...
      <div className="relative">
        ...
        >
          {cards.map((c, i) => (
            ...
            >
              <div
                className="overflow-hidden bg-[#F5F3EF] flex items-center justify-center h-[clamp(280px,50svh,560px)] md:h-[clamp(280px,50vh,560px)]"
              >
                <img
                  src={c.img}
                  alt={c.name}
